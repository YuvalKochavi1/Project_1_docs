...
\begin{enumerate}
    ...
    \item \textbf{Visual Plots:} A 3-panel PNG for the 1D flux (raw, normalised, temperature), and a multi-panel PNG for the 2D radial flux curvature, both saved under \texttt{Figures\_new/\{Experiment\}/\{Material\}/1.5 model/}.
\end{enumerate}
