...
\author[Kochavi et al.]{Yuval Kochavi, Tal Ramot, Tal Balakirski, Shay I. Heizler}
...
\begin{frame}{Photon Transport and Energy Exchange}
    Scattering-free Boltzmann equation for photons (RTE):
    \begin{multline}
...
\begin{frame}{Motivation}
    \begin{figure}
        ...
        {\scriptsize \textit{Shussman at el. POP, (2015)}}
    \end{figure}
    ...
    \begin{itemize}
        ...
        \end{equation*}
        \item The diffusion coefficient $D=\frac{c}{3\rho \kappa}$ is not linear.
        \item The entire system becomes highly non-linear and hard to solve analytically.
...
\begin{frame}{HR Model - Governing Equations}
    ...
    With specific energy and opacity power laws:
    \begin{equation*}
        e = fT^\beta \rho^{-\mu}, \qquad \frac{1}{\kappa} = gT^\alpha \rho^{-\lambda}
    \end{equation*}
...
\begin{frame}{Effective Mean Free Path}
    ...
    Can be modeled as (\textit{Courtois at el. POP, (2024)}):
    \begin{equation*}
