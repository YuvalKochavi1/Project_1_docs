...
\begin{frame}{Slowing the Front: Marshak Boundary Condition}
...
\begin{frame}{Effect of Wall Losses}
...
\begin{frame}{Effective Mean Free Path Results}
...
\begin{frame}{Hurricane \& Hammer: understanding the front curvature}
...
\begin{frame}{Applying on our model: Dynamic Albedo}
    \begin{columns}
        \begin{column}{0.55\textwidth}
            ...
            \begin{equation*}
                \alpha(t) = \frac{F_{\text{out, wall}}}{F_{\text{in,wall}}} = \frac{\sigma_{SB}T_{s,interface}^4 - \frac{dE_{\text{wall}}}{dt}}{\sigma_{SB}T_{s,interface}^4}
            \end{equation*}
...
\begin{frame}{Gold coating - SiO2}
    \begin{figure}
        \centering
        % \includegraphics[width=0.8\textwidth]{figures_intreduction/gold_coating_sio2.png}
        \vspace{5cm} % Large placeholder for the image
    \end{figure}
\end{frame}
...
\begin{frame}{100 times transparenter Gold coating - SiO2}
    \begin{figure}
        \centering
        % \includegraphics[width=0.8\textwidth]{figures_intreduction/100_times_transparenter_gold_coating_sio2.png}
        \vspace{5cm} % Large placeholder for the image
    \end{figure}
\end{frame}
...
\begin{frame}{Copper - SiO2}
    \begin{figure}
        \centering
        % \includegraphics[width=0.8\textwidth]{figures_intreduction/copper_sio2.png}
        \vspace{5cm} % Large placeholder for the image
    \end{figure}
\end{frame}
...
\begin{frame}{Be - SiO2}
    \begin{figure}
        \centering
        % \includegraphics[width=0.8\textwidth]{figures_intreduction/be_sio2.png}
        \vspace{5cm} % Large placeholder for the image
    \end{figure}
\end{frame}
...
\begin{frame}{Vacuum - SiO2}
    \begin{figure}
        \centering
        % \includegraphics[width=0.8\textwidth]{figures_intreduction/vacuum_sio2.png}
        \vspace{5cm} % Large placeholder for the image
    \end{figure}
\end{frame}
...
\begin{frame}{A full 2D Temperature distribution}
    ...
    \begin{figure}
        \centering
        % \includegraphics[width=0.8\textwidth]{figures_intreduction/your_image.png}
        \vspace{4cm} % Large placeholder for the image
    \end{figure}
\end{frame}

\begin{frame}{Comparing to experiments}
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \centering
            % \includegraphics[width=0.9\textwidth]{image1.png}
            \vspace{2.5cm} % Placeholder for image 1
        \end{column}
        \begin{column}{0.5\textwidth}
            \centering
            % \includegraphics[width=0.9\textwidth]{image2.png}
            \vspace{2.5cm} % Placeholder for image 2
        \end{column}
    \end{columns}
    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            ...
            \vspace{2.5cm} % Placeholder for image 3
        \end{column}
        \begin{column}{0.5\textwidth}
            \centering
            % \includegraphics[width=0.9\textwidth]{image4.png}
            \vspace{2.5cm} % Placeholder for image 4
        \end{column}
    \end{columns}
\end{frame}
