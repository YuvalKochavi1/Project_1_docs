...
\begin{frame}[plain]
    \begin{columns}[c]
        \begin{column}{0.58\textwidth}
            ...
            \vspace{0.8cm}
            {\large \textbf{\color{white}Yuval Kochavi}, \color{lightgray}Tal Ramot, \\ \color{lightgray}Tal Balakirski, \color{lightgray}Shay I. Heizler}
            
            % \vspace{0.3cm}
            % {\small Racah Institute of Physics, \\ The Hebrew University of Jerusalem, Israel}
            
            \vspace{1.2cm}
            {\large\textbf{\color{white}ICTT29 | Aix-en-Provence | June 17, 2026}}
        \end{column}
        \begin{column}{0.38\textwidth}
            \centering
            \includegraphics[height=0.9\textheight]{town_vertical.jpg}
        \end{column}
    \end{columns}
\end{frame}
}
...
\begin{frame}{Motivation}
    Radiative heat waves are highly common in High Energy Density Physics:
    \vspace{0.3cm}
    \begin{columns}
        \begin{column}{0.48\textwidth}
            \begin{block}{\centering Inertial Confinement Fusion}
                \centering
                \vspace{0.1cm}
                \includegraphics[width=0.95\textwidth]{figures_intreduction/ICF.png}
                \begin{itemize}
        ...
        \hfill
        \begin{column}{0.48\textwidth}
            \begin{block}{\centering Astrophysics}
                \centering
                \vspace{0.1cm}
                \includegraphics[width=0.95\textwidth]{figures_intreduction/Astro.png}
                \begin{itemize}
    ...
    \begin{columns}
        \begin{column}{0.58\textwidth}
            \begin{itemize}
                ...
                \begin{equation*}
                    e = fT^\beta \rho^{-\mu}, \qquad \frac{1}{\sigma} = \frac{1}{\rho \kappa} = gT^\alpha \rho^{-\lambda}
                \end{equation*}
            \end{itemize}
            
            \vspace{-0.2cm}
            \begin{alertblock}{The Core Challenge}
                The diffusion coefficient $D=\frac{c}{3\rho \kappa}$ and the material internal energy $e$ are highly non-linear. The system becomes very difficult to solve analytically.
            \end{alertblock}
...
\begin{frame} {The Goal}
    \begin{block}{\textbf{Goal}}
       \textbf{ Build a 2D semi-analytical model to understand supersonic heat wave propagation and temperature distribution.}
    \end{block}
    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            ...
            \vspace{0.2cm}
            Meaning, Understanding the following equation:
...
\begin{frame}{Marshak Waves Experiments}
    ...
    Laser $\Rightarrow$ hohlraum $\Rightarrow$ x-ray radiation $\Rightarrow$ supersonic heat wave propagates in the low-density foam 
\end{frame}
...
\begin{frame}{Energy Wall Loss}
    \begin{itemize}
        ...
        \item Can be modeled for different wall materials: \textbf{Gold}, \textbf{Copper}, \textbf{Beryllium}, and \textbf{Vacuum} (without external coating material).
...
\begin{frame}{Flux out of the model}
    \begin{columns}
        \begin{column}{0.5\textwidth}
...
\begin{frame}{100 times optically thinner Gold coating - SiO2}
    \begin{figure}
        \centering
...
\begin{frame}{A full 2D Temperature distribution}
    One can use the 2D Henyey-like profile:
    \begin{equation*}
