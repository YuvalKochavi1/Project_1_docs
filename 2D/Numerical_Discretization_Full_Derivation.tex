...
&\equiv
\frac{\Delta t \cdot r_{j+\frac12}\,D^n_{i,j+\frac12}}{r_j\,\Delta r_j\,\Delta r_{j+\frac12}},\\
\lambda^{r,n}_{i,j-\frac12}
&\equiv
\frac{\Delta t \cdot r_{j-\frac12}\,D^n_{i,j-\frac12}}{r_j\,\Delta r_j\,\Delta r_{j-\frac12}}.
\end{align}
...
\begin{equation}
\Delta t \left[\frac{1}{r}\frac{d}{dr}\left(rD^n\frac{\partial E}{\partial r}\right)\right]_{i,j}^{n+1}
\approx
...
\begin{equation}
\Delta t \left[\frac{\partial}{\partial z}\left(D^n\frac{\partial E}{\partial z}\right)\right]_{i,j}^{n+1}
\approx
\frac{\Delta t \cdot D^n_{i,j}}{(\Delta z)^2}
...
Then:
\begin{equation}
\Delta t \left[D\frac{\partial^2 E}{\partial z^2}\right]_{i,j}^{n+1}
\approx
...
-
\left[\Delta t \mathcal{L}_r + \Delta t \mathcal{L}_z\right] E^{n+1}_{i,j}
=
